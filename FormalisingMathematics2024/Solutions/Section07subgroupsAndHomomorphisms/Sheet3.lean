...
#align_import solutions.section07subgroups_and_homomorphisms.sheet3
...
example : (QuotientGroup.mk' N).ker = N := by
  ext a
  rw [MonoidHom.mem_ker]
  have h : QuotientGroup.mk' N 1 = 1 := MonoidHom.map_one _
