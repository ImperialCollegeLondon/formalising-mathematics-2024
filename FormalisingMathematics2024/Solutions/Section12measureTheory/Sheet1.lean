...
#align_import solutions.section12measure_theory.sheet1
...
example (A : Set X) :
    (MeasurableSpace.generateFrom {A}).MeasurableSet' = ({∅, A, Aᶜ, ⊤} : Set (Set X)) :=
  by
  ext B
  ...
  · intro h
    ...
    · left; rfl
    · rcases hC2 with (rfl | rfl | rfl | rfl) <;> finish
    · dsimp at hf2 
