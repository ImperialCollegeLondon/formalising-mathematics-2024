...
#align_import solutions.section15number_theory.sheet3
...
theorem arb_large_soln : ∀ N : ℕ, ∃ n > N, 5 ∣ 4 * n ^ 2 + 1 ∧ 13 ∣ 4 * n ^ 2 + 1 :=
  by
  intro N
...
theorem infinite_iff_arb_large (S : Set ℕ) : S.Infinite ↔ ∀ N, ∃ n > N, n ∈ S :=
  by
  constructor
  · intro h n
