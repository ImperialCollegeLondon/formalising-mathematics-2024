...
#align_import section09bijections_and_isomorphisms.sheet1
...
example : (∃ g : Y → X, f ∘ g = id ∧ g ∘ f = id) → f.Bijective := by sorry
...
example : f.Bijective → ∃ g : Y → X, f ∘ g = id ∧ g ∘ f = id := by sorry
